...
if(!in_array($ext,$ekstensi) ) { //jika ekstensi gambar berbeda
    header("location:databuku.php?alert=gagal_ekstensi");
}else{
    if($ukuran < 1044070){ //jika size foto sesuai
     ...
     header("location:databuku.php?alert=berhasil");

    }else{
        header("location:databuku.php?alert=gagal_ukuran");
    }
}
}
?>
                        ...
                        <div class="card">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="pengarang" placeholder="Pengarang Buku" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Penerbit</label>
                                    <input type="text" class="form-control" name="penerbit" placeholder="Penerbit Buku" required>
                                </div>
                                <div class="mb-3">
