...
<head>
    ...
    <title>Daftar Buku - Cun Book Store</title>
    <!-- Custom CSS -->
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="daftarbuku.php" class="sidebar-link"><span
                                            class="hide-menu"> Daftar Buku
                                        </span></a>
                                </li>
                    </ul>
                </nav>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Daftar Buku</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="daftarbuku.php" class="text-muted">Buku</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Daftar Buku</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="section">
                                <div class="container"><br>
                                    <h2>Deskripsi Produk</h3><br>
                                    <div class="box">
                                        <div class="col-8">
                                            <img src="img/<?php echo $b->gambar ?>" width="35%">
                                        </div>
                                        <div class="col-8"><br>
                                            <h4>Judul     : <?php echo $b->judul ?></h4>
                                            <h4>Pengarang : <?php echo $b->pengarang ?></h4>
